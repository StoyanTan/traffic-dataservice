...
public interface ITrafficService {
	...
	Response getIncidentsByCity(@PathVariable String city, @RequestParam Integer page);
	...
	Response getIncidentsById(@PathVariable String id);
}
